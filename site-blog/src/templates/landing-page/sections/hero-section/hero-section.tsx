...
export const HeroSection = () => {
  return (
    <section className="container relative flex items-center justify-center mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gag-8 min-h-[20rem] md:h-[36rem] items-center">
        <div className="flex flex-col itens-center justify-center gap-4 md:items-start lg:items-start">
          ...
          <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-body-md text-gray-200">Crie o seu site em menos de 5 minutos</span>
              </div>

              <div className="flex items-center gap-2">
                <Store className="text-cyan-100 h-4 w-4" />
                <span className="text-body-md text-gray-200">Acompanhe e otimize seu negócio online</span>
              </div>
            </div>

            <div className="text-white flex flex-col gap-2 mt-8 items-center md:intems-start lg:items-start">
        ...
        <div className="relative h-[20rem] hidden md:h-full order-first md:order-last items center justify-center md:flex lg:flex">
          <Image
            ...
            alt="Ilustraçao com ícones de store, tag e sacola"
            width={200}
            height={400}
